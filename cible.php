<?php 
       /*cette requête permet d'enregistrer nos champs rempli par l'utilisateur afin de sauvegarder dans notre db le pseudo, le mdp et le mail qui nous servirons à l'identifier lors de sa futur connexion*/
		...
		$requete = $bdd -> prepare('INSERT INTO utilisateur(username, password, mail) VALUES(?,?,?)'); 
		$requete -> execute(array($_POST['username'], $_POST['password'], $_POST['mail'])); 
?>
...
<p>Vous avez reçu un mail de validation de compte à <?php echo htmlspecialchars($_POST['mail']); ?>. 
	...
	Nous vous invitons à inscrire les différents produits que vous voudriez mettre en ligne.  <a href="produits_clients.php"> clique ici</a> pour les inscrires.</p>
